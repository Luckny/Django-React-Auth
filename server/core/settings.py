...
# To load environnement variables like api keys and database login information
load_dotenv()
...
SECRET_KEY = "django-insecure--=xzajmfe86rxh@$%(%q#3d)6x*$&x&$m_tg-7*-1wp_6qi-u&"
...
DATABASES = {
    "default": {
        "ENGINE": (
            "django.db.backends.sqlite3" if is_test() else "django.db.backends.mysql"
        ),
...
# Required to change the default model auth.User
